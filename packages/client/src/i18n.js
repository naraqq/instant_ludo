...
const STRINGS = {
  en: {
    ...
    'setup.header': 'PLAY',
    'setup.players': 'SELECT PLAYERS',
    'setup.playersWord': 'Players',
    'setup.teamUp': 'Team up',
    'setup.bet': 'CHOOSE BET',
    'setup.win': 'Win',
    'setup.entry': 'Entry',
    'setup.start': 'START',
    'setup.notEnough': 'Not enough coins for that bet',
    'setup.friends': 'Play with a friend',
    'setup.createRoom': 'Create room',
    'setup.enterCode': 'Enter code',
    'setup.wonPot': '+{n} coins — you won the pot!',
    'setup.lostBet': '−{n} coins',

    'net.connecting': 'Connecting…',
    'net.waiting': 'Waiting for an opponent…\n({n}/{max})',
    'net.theirTurn': "{name}'s turn",
    'net.assist': 'Roll for {name}',
    'net.assistOther': '{name} rolls for {mate}',
    'net.colorHome': '{name} is all home!',
    'net.powerUsed': '{name} used {power}',
    'net.powerReceived': '{name} received {power}',
    ...
    'classic.diceSet': 'Set to {n}',
    'classic.threeSixes': 'Three 6s — turn passes',
    ...
    'victory.teamHome': '{team} brought all eight pawns home',
    'victory.place1': '1st',
    'victory.place2': '2nd',
    'victory.place3': '3rd',
    'victory.place4': '4th',
  ...
  mn: {
    ...
    'setup.header': 'ТОГЛОХ',
    'setup.players': 'ТОГЛОГЧ СОНГОХ',
    'setup.playersWord': 'Тоглогч',
    'setup.teamUp': 'Багаар',
    'setup.bet': 'МӨРИЙ СОНГОХ',
    'setup.win': 'Хожвор',
    'setup.entry': 'Орох',
    'setup.start': 'ЭХЛЭХ',
    'setup.notEnough': 'Энэ мөрийд зоос хүрэлцэхгүй байна',
    'setup.friends': 'Найзтайгаа тоглох',
    'setup.createRoom': 'Өрөө үүсгэх',
    'setup.enterCode': 'Код оруулах',
    'setup.wonPot': '+{n} зоос — бүлээ хожлоо!',
    'setup.lostBet': '−{n} зоос',

    'net.connecting': 'Холбогдож байна…',
    'net.waiting': 'Өрсөлдөгч хүлээж байна…\n({n}/{max})',
    'net.theirTurn': '{name}-ийн ээлж',
    'net.assist': '{name}-ийн төлөө хая',
    'net.assistOther': '{name} → {mate}-ийн төлөө хаяж байна',
    'net.colorHome': '{name} бүх хүүгээ оруулж дууслаа!',
    'net.powerUsed': '{name}: {power}',
    'net.powerReceived': '{name}: {power} авлаа',
    ...
    'classic.diceSet': '{n} болгов',
    'classic.threeSixes': 'Гурван 6 — ээлж алдав',
    ...
    'victory.teamHome': '{team} найман хүүгээ бүгдийг гэртээ оруулав',
    'victory.place1': '1-Р',
    'victory.place2': '2-Р',
    'victory.place3': '3-Р',
    'victory.place4': '4-Р',

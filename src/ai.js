...
import { SAFE_STOPS, START_INDEX, TRACK, HOME_ENTRY, FINISH_STEPS } from './scenes/board.js'
...
function scoreMove(state, pawn) {
  ...
  const rune = state.runes.find((r) => r.index === L.trackIndex)
  if (rune) s += rune.type === 'air' ? 14 : 22
